package com.broadfactor.api.configuration.filter;
...
public class CustomAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	public CustomAuthenticationFilter(AuthenticationManager autheticationManager) {
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		return autheticationManager.authenticate(authenticationToken);
	}
